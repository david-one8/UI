      ...
      {patients.map((patient, index) => {
        ...
        return (
          <div
            ...
            className="animate-fade-slide-in bg-white border border-gray-200 rounded-xl p-5
          ...
          >
            ...
            <div className="flex items-start justify-between mb-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-sm font-semibold text-gray-900 leading-tight truncate max-w-[140px]">
                    {patient.patient_name}
                  </h3>
                  <p className="text-xs text-gray-400">{formatId(patient.patient_id)}</p>
                </div>
              </div>
