...
export default function PatientDirectory() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-linear-to-r from-teal-700 to-emerald-600 relative overflow-hidden">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="relative inline-flex bg-gray-100 p-1 rounded-xl">
            ...
            <button
              ...
              className={`relative z-10 px-4 py-1.5 text-sm font-medium rounded-lg
                          ...
                          ${viewMode === "table" ? "text-gray-900" : "text-gray-500 hover:text-gray-700"}`}
            >
              Table View
            </button>
            <button
              ...
              className={`relative z-10 px-4 py-1.5 text-sm font-medium rounded-lg
                          transition-colors duration-200
                          ${viewMode === "card" ? "text-gray-900" : "text-gray-500 hover:text-gray-700"}`}
            >
              Card View
            </button>
          </div>
          ...
          <div className="flex items-center gap-1.5 px-3 py-1.5 text-sm text-gray-500 border border-gray-200 rounded-lg bg-white">
        ...
        {filters.medicalIssue.length > 0 && (
          <div className="flex flex-wrap gap-2 mb-4">
            {filters.medicalIssue.map((issue) => (
              <span
                key={issue}
                className="inline-flex items-center gap-1 px-3 py-1 text-sm bg-gray-100 border
                           border-gray-200 rounded-full capitalize animate-chip-in"
              >
                {issue}
                <button
                  onClick={() =>
        ...
        <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
          {loading ? (
            ...
            <div className="animate-fade-slide-in flex flex-col items-center justify-center py-16 text-gray-400">
